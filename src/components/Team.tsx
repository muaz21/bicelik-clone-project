  ...
  return (
    <section id="team" className="py-14">
      <div className="max-w-screen-xl mx-auto px-4 text-center md:px-8">
        ...
        <div className="mt-12">
          <ul className="grid gap-8 sm:grid-cols-2 md:grid-cols-3 place-items-center">
            {team.map((user) => (
              <li
                key={user.name}
                className="border border-gray-500 hover:shadow-xl transition-all w-full p-2 rounded">
                ...
                <div className="mt-2">
                  ...
                  <div className="mt-4 flex justify-center gap-4 text-gray-400">
                    <a target="_blank" href={user.ig_link || user.linked_in}>
                      {user.ig_link && (
                        <svg
